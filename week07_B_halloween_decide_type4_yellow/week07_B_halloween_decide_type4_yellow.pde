...
void draw(){
  ...
  println(rightdown);
  if(dpx>100 && dpy<40) stroke(255,0,0);   //type 1 紅色的橫線
  else if(dpx<40 && dpy>100) stroke(0,0,255); //type 2 藍色的直線
  else if(green_ok) stroke(0,255,0); //type 3 全部完成
  //else if(green_part1) stroke(0,128,0); //暗暗的綠色, type 3 的前半段,往右下
  else if(yellow_ok) stroke(255,255,0); //type 4 全部完成
